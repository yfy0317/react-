  ...
  (t.prototype.needsClick = function(t) {
    switch (t.nodeName.toLowerCase()) {
      ...
      case "textarea":
        ...
        break;
      case "input":
        if ((o && t.type === "file") || t.disabled) return !0;
        break;
      case "label":
      case "iframe":
      case "video":
    ...
    (t.prototype.determineEventType = function(t) {
      return n && t.tagName.toLowerCase() === "select" ? "mousedown" : "click";
    }),
    ...
    (t.prototype.onClick = function(t) {
      ...
      return this.trackingClick
        ...
        : t.target.type === "submit" && t.detail === 0
        ? !0
    ...
    (t.notNeeded = function(t) {
      ...
      return t.style.msTouchAction === "none" ||
