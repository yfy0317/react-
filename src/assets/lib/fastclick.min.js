!(function() {
            ...
            n &&
                ...
                Event.prototype.stopImmediatePropagation ||
                    ((e.removeEventListener = function(t, n, o) {
                        let i = Node.prototype.removeEventListener;
                        "click" === t
                            ? i.call(e, t, n.hijacked || n, o)
                            : i.call(e, t, n, o);
                    }),
                    (e.addEventListener = function(t, n, o) {
                        let i = Node.prototype.addEventListener;
                        "click" === t
                            ? i.call(
                                  e,
                                  t,
    ...
    (t.prototype.needsClick = function(t) {
        ...
        (t.prototype.determineEventType = function(t) {
            return n && t.tagName.toLowerCase() === "select"
                ? "mousedown"
                : "click";
        }),
        ...
        (t.prototype.onTouchEnd = function(t) {
            ...
            return o &&
                ...
                ? !0
                : (this.needsClick(l) ||
                      (t.preventDefault(), this.sendClick(l, t)),
                  !1);
        }),
        ...
        (t.prototype.onClick = function(t) {
            ...
            return this.trackingClick
                ...
                : "submit" === t.target.type && t.detail === 0
                ? !0
        ...
        (t.notNeeded = function(t) {
            ...
            if (
                (o = +(/Chrome\/([0-9]+)/.exec(navigator.userAgent) || [
                    ,
                    0
                ])[1])
            ) {
