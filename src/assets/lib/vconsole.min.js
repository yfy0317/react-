...
!(function(e, t) {
  ...
  return (function(e) {
    function t(n) {
      ...
      let r = (o[n] = { exports: {}, id: n, loaded: !1 });
          ...
          return (
            l(e, [
                ...
                value() {
                  ...
                  d.default.bind(t, "touchstart", function(t) {
                    ...
                    d.default.bind(
                      ...
                      "click",
                      function(t) {
                        return t.target != d.default.one(".vc-mask")
                          ? !1
                          : void e.hide();
                      }
                    ),
                ...
                value(e) {
                  ...
                  e.trigger("init"),
                    e.trigger("renderTab", function(o) {
                      t.tabList.push(e.id);
                      let n = d.default.render(p.default, {
                        id: e.id,
                        name: e.name
                      });
                      d.default.one(".vc-tabbar", t.$dom).appendChild(n);
                      let r = d.default.render(g.default, { id: e.id });
                      o &&
                        (a.isString(o)
                          ? (r.innerHTML += o)
                    ...
                    e.trigger("addTool", function(t) {
                      if (t) {
                        for (
                          var o = d["default"].one(".vc-tool-last"), n = 0;
                          n < t.length;
                          n++
                        ) {
                          var r = t[n],
              ...
              },
              {
                key: "showTab",
                value(e) {
                  let t = d.default.one("#__vc_log_" + e);
    ...
    function(e, t) {
      ...
      function f(e) {
        return "object" ===
          ("undefined" === typeof HTMLElement ? "undefined" : h(HTMLElement))
          ? e instanceof HTMLElement
          : e &&
              "object" === (typeof e === "undefined" ? "undefined" : h(e)) &&
              e !== null &&
              e.nodeType === 1 &&
              ...
              },
              {
                ...
                value(e, t) {
                  if (typeof this.eventList[e] === "function") {
                    ...
                    let o = "on" + e.charAt(0).toUpperCase() + e.slice(1);
      ...
      let _createClass = (function() {
        ...
        VConsoleDefaultTab = (function(_VConsoleLogTab) {
          function VConsoleDefaultTab() {
            ...
            let r = _possibleConstructorReturn(
              this,
          ...
          return (
            ...
            s(t, [
              ...
              },
              {
                key: "renderLog",
                value(e) {
                  let t = v.default.render(h.default, e);
            ...
            a(t, [
              ...
              },
              {
                ...
                value() {
                  ...
                  let c = e.match(/MicroMessenger\/([\d\.]+)/i);
                  (t = "Unknown"),
                    c &&
                      c[1] &&
          ...
          return (
            ...
            a(t, [
              ...
              },
              {
                ...
                value(e, t) {
                  ...
                  n.status >= 400 &&
                    ...
                    (this.domList[e] = l);
                  let a = Object.keys(this.reqList).length;
                  ...
                  if (e) {
                    ...
                    window.XMLHttpRequest.prototype.open = function() {
                      let e = this,
                        ...
                        i = t.getUniqueID();
                      e._requestID = i;
                      let l = e.onreadystatechange || function() {};
                      return (
              ...
              },
              {
                key: "getUniqueID",
                value() {
                  let e = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
                    /[xy]/g,
                    function(e) {
