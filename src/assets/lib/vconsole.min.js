...
!(function(e, t) {
  ...
  (function(e) {
    function t(n) {
      ...
      const r = (o[n] = { exports: {}, id: n, loaded: !1 });
      ...
      let u = o(9),
        ...
        m = (function() {
          function e() {
            ...
            const o = function() {
              t._render(), t._bindEvent(), t._autoRun();
            };
            document.readyState == "complete"
              ? o()
              : d.default.bind(window, "load", o);
          }
          return (
            l(e, [
              {
                ...
                value() {
                  ...
                  let o = a.getStorage("switch_x"),
                    n = a.getStorage("switch_y");
                  o &&
                    n &&
                    ((this.switchPos.x = o),
                    (this.switchPos.y = n),
                    (d.default.one(".vc-switch").style.right = `${o}px`),
                    (d.default.one(".vc-switch").style.bottom = `${n}px`));
                }
              },
              {
                key: "_bindEvent",
                value() {
                  ...
                  d.default.bind(t, "touchstart", t => {
                    (e.switchPos.startX = t.touches[0].pageX),
                      (e.switchPos.startY = t.touches[0].pageY);
                  }),
                    d.default.bind(t, "touchend", t => {
                      (e.switchPos.endX == 0 && e.switchPos.endY == 0) ||
                    ...
                    d.default.bind(t, "touchmove", o => {
                      if (o.touches.length > 0) {
                        ...
                        i < 0 && (i = 0),
                          l < 0 && (l = 0),
                          i + t.offsetWidth > document.body.offsetWidth &&
                            (i = document.body.offsetWidth - t.offsetWidth),
                          l + t.offsetHeight > document.body.offsetHeight &&
                            (l = document.body.offsetHeight - t.offsetHeight),
                          (t.style.right = `${i}px`),
                          (t.style.bottom = `${l}px`),
                          (e.switchPos.endX = i),
                          (e.switchPos.endY = l),
                    ...
                    d.default.bind(
                      d.default.one(".vc-mask", e.$dom),
                      "click",
                      t =>
                        t.target != d.default.one(".vc-mask")
                          ? !1
                          : void e.hide()
                    ),
                    d.default.delegate(
                      d.default.one(".vc-tabbar", e.$dom),
                      "click",
                      ".vc-tab",
                      function(t) {
              ...
              },
              {
                ...
                value() {
                  this.isReady = !0;
                  for (const e in this.pluginList) {
              ...
              },
              {
                ...
                value(e) {
                  const t = this;
                  e.trigger("init"),
                    e.trigger("renderTab", o => {
                      t.tabList.push(e.id);
                      const n = d.default.render(p.default, {
                        id: e.id,
                        name: e.name
                      });
                      d.default.one(".vc-tabbar", t.$dom).appendChild(n);
                      const r = d.default.render(g.default, { id: e.id });
                      o &&
                        (a.isString(o)
                          ? (r.innerHTML += o)
                          : a.isFunction(o.appendTo)
                          ? o.appendTo(r)
                          : a.isElement(o) && r.appendChild(o)),
                        d.default.one(".vc-content", t.$dom).appendChild(r);
                    }),
                    e.trigger("addTool", t => {
                      if (t) {
                        for (
                          let o = d.default.one(".vc-tool-last"), n = 0;
                          n < t.length;
                          n++
                        ) {
                          let r = t[n],
                          ...
                          r.global == 1 &&
                            ...
                            a.isFunction(r.onClick) &&
                              d.default.bind(i, "click", r.onClick),
              ...
              },
              {
                ...
                value(e) {
                  for (const t in this.pluginList) {
              ...
              },
              {
                key: "show",
                value() {
                  d.default.addClass(this.$dom, "vc-toggle"),
              ...
              },
              {
                ...
                value() {
                  (document.body.style.overflow = this.bodyOverflowCSS),
                    d.default.removeClass(this.$dom, "vc-toggle"),
              ...
              },
              {
                key: "showTab",
                value(e) {
                  const t = d.default.one(`#__vc_log_${e}`);
                  d.default.removeClass(
                    d.default.all(".vc-tab", this.$dom),
                    "vc-actived"
                  ),
                    d.default.addClass(
                      d.default.one(`#__vc_tab_${e}`),
                      "vc-actived"
                    ),
                    d.default.removeClass(
                      d.default.all(".vc-logbox", this.$dom),
                      "vc-actived"
                    ),
                    d.default.addClass(t, "vc-actived"),
                    (d.default.one(
                      ".vc-content",
                      this.$dom
                    ).scrollTop = d.default.one(
                      ".vc-content",
                      this.$dom
                    ).scrollHeight),
                    d.default.removeClass(
                      d.default.all(".vc-tool", this.$dom),
                      "vc-actived"
                    ),
                    d.default.addClass(
                      d.default.all(`.vc-tool-${e}`, this.$dom),
                      "vc-actived"
                    ),
    ...
    function(e, t) {
      ...
      function d(e) {
        return !(
          ...
          (n(e) || r(e) || l(e) || i(e) || a(e) || u(e) || c(e) || s(e))
        );
      }
      function u(e) {
      ...
      function p(e) {
        ...
        function o(e) {
          if (d(e)) {
            ...
            p.push({ parent, child: e });
            const b = Object.keys(e);
            (f += "{"), v++;
            for (let g = 0; g < b.length; g++) {
              const h = b[g];
              e.hasOwnProperty(h) &&
                ((f += `${h}: `), o(e[h], e), g < b.length - 1 && (f += ", "));
            }
            v--, (f += "}"), p.pop();
          } else if (i(e)) {
            if (t(e)) return void (f += "CircularArray");
            p.push({ parent, child: e }), (f += "["), v++;
            for (let y = 0; y < e.length; y++) {
              o(e[y], e), y < e.length - 1 && (f += ", ");
            }
            v--, (f += "]"), p.pop();
          } else {
            f += r(e)
    ...
    function(e, t, o) {
      ...
      (c.one = function(e, t) {
        ...
        (c.hasClass = function(e, t) {
          if (!e) return !1;
          for (let o = e.className.split(" "), n = 0; n < o.length; n++) {
            if (o[n] == t) return !0;
          }
          return !1;
        }),
        (c.bind = function(e, t, o, n) {
          if (e) {
            void 0 === n && (n = !1), (0, r.isArray)(e) || (e = [e]);
          ...
          e &&
            e.addEventListener(
              ...
              t => {
                const r = c.all(o, e);
                if (r) {
                  e: for (let i = 0; i < r.length; i++) {
                    for (let l = t.target; l; ) {
                      if (l == r[i]) {
                        n.call(l, t);
                        break e;
                      }
                      if (((l = l.parentNode), l == e)) {
                        break;
                      }
                    }
                  }
    ...
    function(e, t) {
      function o(e, t, o) {
        ...
        for (
          ...
          c(e.slice(i, l.index), !1), c(l[1], !0), (i = l.index + l[0].length);
        }
        c(e.substr(i, e.length - i), !1),
          (r += 'return arr.join("");'),
          (r = `with (this) {\n${r}\n}`);
        let a = new Function(r).apply(t);
        if (!o) {
          const s = document.createElement("div");
          (s.innerHTML = a), (a = s.children[0]);
        }
        return a;
      }
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        return (
          ...
          (e.i = function(t, o) {
            ...
            for (var n = {}, r = 0; r < this.length; r++) {
              const i = this[r][0];
              typeof i === "number" && (n[i] = !0);
            }
            for (r = 0; r < t.length; r++) {
              const l = t[r];
              (typeof l[0] === "number" && n[l[0]]) ||
                (o && !l[2] ? (l[2] = o) : o && (l[2] = `(${l[2]}) and (${o})`),
                e.push(l));
            }
          }),
          e
    ...
    function(e, t, o) {
      ...
      function f(e, t) {
        ...
        let r = new Blob([o], { type: "text/css" }),
          i = e.href;
      ...
      var v = {},
        p = function(e) {
          ...
          return function() {
            return (
              typeof t === "undefined" && (t = e.apply(this, arguments)), t
            );
          };
        },
        b = p(() =>
        ...
        g = p(() => document.head || document.getElementsByTagName("head")[0]),
        h = null,
        y = 0,
        m = [];
      e.exports = function(e, t) {
        (t = t || {}),
          typeof t.singleton === "undefined" && (t.singleton = b()),
    ...
    function(e, t) {
      e.exports =
        '<div id=__vconsole class=""> <div class=vc-switch>vConsole</div> <div class=vc-mask> </div> <div class=vc-panel> <div class=vc-tabbar> </div> <div class=vc-content> </div> <div class=vc-toolbar> <a class="vc-tool vc-global-tool vc-tool-last vc-hide">Hide</a> </div> </div> </div>';
    },
    function(e, t) {
      e.exports =
      ...
      let _createClass = (function() {
        ...
        VConsoleDefaultTab = (function(_VConsoleLogTab) {
          function VConsoleDefaultTab() {
            ...
            const r = _possibleConstructorReturn(
              this,
              (e = Object.getPrototypeOf(VConsoleDefaultTab)).call.apply(
                e,
                [this].concat(o)
              )
            );
            return (r.tplTabbox = _tabbox_default2.default), r;
          }
          return (
            ...
            _createClass(VConsoleDefaultTab, [
              {
                ...
                value() {
                  const e = this;
                  _get(
                    Object.getPrototypeOf(VConsoleDefaultTab.prototype),
                    "onReady",
                    this
                  ).call(this),
                    _query2.default.bind(
                      _query2.default.one(".vc-cmd", this.$tabbox),
                      "submit",
                      t => {
                        t.preventDefault();
                        let o = _query2.default.one(".vc-cmd-input", t.target),
                          n = o.value;
              ...
              },
              {
                ...
                value: function evalCommand(cmd) {
                  const date = tool.getDate(+new Date());
                  this.renderLog({
                    logType: "log",
                  ...
                  (content =
                    tool.isArray(result) || tool.isObject(result)
                      ? this.getFoldedLine(result)
                      : _query2.default.render(
                          _item_code2.default,
                          {
                            content: result,
                            type: "output"
            ...
            s(t, [
              {
                ...
                value() {
                  ...
                  for (let e = 0; e < this.logList.length; e++) {
              ...
              },
              {
                ...
                value() {
                  v.default.bind(
                    v.default.one(".vc-log", this.$tabbox),
                    "click",
                    e => {
                      const t = e.target;
                      v.default.hasClass(t, "vc-fold-outer") &&
                        (v.default.hasClass(t.parentElement, "vc-toggle")
              ...
              },
              {
                ...
                value() {
                  ...
                  window.console
                    ...
                    (window.onerror = function(e, t, o, n, r) {
                      let i = r.stack.split("at");
                      (i = `${i[0]} ${i[1]}`),
                        (i = i.replace(location.origin, "")),
                        console.error(i);
                    });
                }
              },
              ...
              },
              {
                ...
                value(e) {
                  ...
                  if (t.length) {
                    ...
                    if (u.isString(t[0])) {
                      const i = t[0].match(n);
                      i !== null && i.length > 0 && (r = i[1].toLowerCase());
                    }
                    if (
                      (r
                        ? (o = r == this.id)
                        : this.allowUnformattedLog == 0 && (o = !1),
                      !o)
                    ) {
                      return void this.printOriginLog(e);
                    }
                    ...
                    for (var l = "", c = 0; c < t.length; c++) {
                      try {
                        ...
                        l += u.isFunction(t[c])
                          ? ` ${t[c].toString()}`
                          : u.isObject(t[c]) || u.isArray(t[c])
                          ? ` ${this.getFoldedLine(t[c])}`
                          : ` ${u.htmlEncode(t[c]).replace(/\n/g, "<br/>")}`;
                      } catch (s) {
                        l += ` [${a(t[c])}]`;
                      }
                    }
                    const d = u.getDate(e.date);
                    this.renderLog({
                      logType: e.logType,
                      content: l,
              ...
              },
              {
                key: "renderLog",
                value(e) {
                  const t = v.default.render(h.default, e);
                  v.default.one(".vc-log", this.$tabbox).appendChild(t),
                    (v.default.one(".vc-content").scrollTop = v.default.one(
                      ".vc-content"
                    ).scrollHeight);
                }
              },
                ...
                value(e) {
                  function t(e) {
                    for (let t = s.length - 1; t >= 0; t--) {
                      if (s[t].child == e) return !0;
                    }
                    return !1;
                  }
                  function o(e, n) {
                    if (u.isObject(e)) {
                      if (t(e)) return void (i += "{Circular Object}");
                      s.push({ parent: n, child: e });
                      ...
                      c--, (i += `\n${Array(c + 1).join(a)}}`), s.pop();
                    } else if (u.isArray(e)) {
                      if (t(e)) return void (i += "[Circular Array]");
                      s.push({ parent: n, child: e }), (i += "[\n"), c++;
    ...
    function(e, t) {
      e.exports =
        '<div class="vc-item vc-item-{{logType}} {{style}}"> <span class=vc-item-meta>{{meta}}</span> <div class=vc-item-content>{{content}}</div> </div>';
    },
    function(e, t) {
      e.exports =
        '<div class=vc-fold> <i class=vc-fold-outer>{{outer}}</i> <pre class="vc-fold-inner vc-max-height">{{inner}}</pre> </div>';
    },
    function(e, t) {
      ...
      let a = (function() {
        ...
        g = (function(e) {
          function t() {
            ...
            return (c.tplTabbox = b.default), (c.allowUnformattedLog = !1), c;
          }
          return (
            c(t, e),
            a(t, [
              ...
              },
              {
                ...
                value() {
                  ...
                  l
                    ...
                    : r
                    ? (t = `iPad, iOS ${r[2].replace(/_/g, ".")}`)
                    : n && (t = `iPod, iOS ${n[2].replace(/_/g, ".")}`),
                    console.info("[system]", "System:", t);
                  const c = e.match(/MicroMessenger\/([\d\.]+)/i);
                  (t = "Unknown"),
                    c &&
                      c[1] &&
                      ((t = c[1]), console.info("[system]", "WeChat:", t));
                  let a = e.toLowerCase().match(/ nettype\/([^ ]+)/g);
                  (t = "Unknown"),
                    a &&
                      a[0] &&
                      ((a = a[0].split("/")),
                  ...
                  if (s && s.timing) {
                    ...
                    console.info(
                      ...
                      d.secureConnectionStart > 0 &&
                        console.info(
                          "[system]",
                          "SSL Cost:",
                          `${d.connectEnd - d.secureConnectionStart}ms`
                        ),
                      console.info(
                        "[system]",
                        "DomRenderCost:",
                        `${d.domComplete - d.domLoading}ms`
                      );
                  }
      ...
      let a = (function() {
        ...
        x = (function(e) {
          function t() {
            ...
            return (
              (c.$tabbox = d.default.render(g.default, {})),
              (c.$header = null),
              (c.reqList = {}),
              (c.domList = {}),
              c.mockAjax(),
            ...
            a(t, [
                  ...
                  this.renderHeader(),
                    d.default.delegate(
                      ...
                      function(e) {
                        ...
                        d.default.hasClass(t, "vc-actived")
                          ? d.default.removeClass(t, "vc-actived")
                          : d.default.addClass(t, "vc-actived"),
                          e.preventDefault();
                      }
                    );
              ...
              },
              {
                ...
                value(e, t) {
                  ...
                  n.readyState <= 1
                    ? (i.status = "Pending")
                    : n.readyState < 4 && (i.status = "Loading");
                  let l = d.default.render(_.default, i),
                    c = this.domList[e];
                  n.status >= 400 &&
                    d.default.addClass(
                    ...
                    c
                      ...
                      : d.default.one(".vc-log", this.$tabbox).appendChild(l),
                    (this.domList[e] = l);
                  const a = Object.keys(this.reqList).length;
                  ...
                  if (e) {
                    ...
                    window.XMLHttpRequest.prototype.open = function() {
                      let e = this,
                        ...
                        i = t.getUniqueID();
                      e._requestID = i;
                      const l = e.onreadystatechange || function() {};
                      return (
                        (e.onreadystatechange = function() {
                          ...
                          return t.updateRequest(i, o), l.apply(e, arguments);
                        }),
                        o.apply(e, n)
                      );
                    };
