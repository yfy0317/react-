!(function(e) {
    ...
    function a(e, t) {
        ...
        return e
            ? !!e.match(r) ||
                  (t || console.error("Fundebug: apikey格式错误"), !1)
    ...
    function u() {
        for (
            ...
            let n = r.toString().match(/function\s*([\w\_$]+)?\s*\(/i);
        ...
        console[t] = function() {
            if (
                ...
                if (r.apply) r.apply(console, arguments);
                    ...
                    let n = Array.prototype.slice.apply(arguments).join(" ");
                    r(n);
                }
            }
        };
    ...
    "EventTarget Window Node ApplicationCache AudioTrackList ChannelMergerNode CryptoOperation EventSource FileReader HTMLUnknownElement IDBDatabase IDBRequest IDBTransaction KeyOperation MediaController MessagePort ModalWindow Notification SVGElementInstance Screen TextTrack TextTrackCue TextTrackList WebSocket WebSocketWorker Worker XMLHttpRequest XMLHttpRequestEventTarget XMLHttpRequestUpload".replace(
        ...
        function(t) {
            if (H) {
                let a = e[t] && e[t].prototype;
                a &&
                    a.hasOwnProperty &&
                    a.hasOwnProperty("addEventListener") &&
                    (r(a, "addEventListener", function(e) {
                    ...
                    r(a, "removeEventListener", function(e) {
                        return function(t, r, a) {
                            return (
                                e.call(this, t, r, a), e.call(this, t, n(r), a)
                            );
                        };
                    }));
            }
    ...
    e.onpopstate = function() {
        let t = { url: e.location.href };
        if (
            (M.title || (M.title = document.title),
            M.url !== t.url && d(M, t),
            R)
        ) {
    ...
    let j = e.onhashchange;
    e.onhashchange = function() {
        let t = { url: e.location.href, title: document.title };
    ...
    let O = !1;
    if (e.XMLHttpRequest) {
        let _ = XMLHttpRequest.prototype;
        if (!_) return;
        let X,
            C,
            F,
